 ...
 *
 */
class UserDockSelectGUI extends JFrame implements ActionListener {

	private DockList dockList;
	private UserList userList;
	private TransactionList transactionList;

	private DockFunctionGUI dockFunctionGUI;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (eventSource.equals(this.closeButton)) {
			...
			dockFunctionGUI = new DockFunctionGUI(0, dockList, userList, transactionList);
		}
		else if(eventSource.equals(this.dockB)) {
			System.out.println("dockb");
			dockFunctionGUI = new DockFunctionGUI(1, dockList, userList, transactionList);
		}
		else if(eventSource.equals(this.dockC)) {
			System.out.println("dockc");
			dockFunctionGUI = new DockFunctionGUI(2, dockList, userList, transactionList);
		}
